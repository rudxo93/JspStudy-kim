        ...
        <main>
            <div class="mypage-content">
                ...
                <div class="mypage-items">
                    <div class="item_tf">
                        <input type="hidden" id="user_email" name="user_email" value="${login_user.id }"> <!-- session에서 값 들고오기 -->
                        <label class="item_lb" for="">${login_user.id }@kakao.com</label>
                    </div>
                    <div class="item_tf">
                    	<input type="hidden" name="user_password" value="${login_user.password }"><!-- session에서 값 들고오기 -->
